      ...
      <header className="sticky top-0 z-40 w-full bg-card/80 backdrop-blur-lg border-b border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center h-14 gap-6">
          ...
          <div className="flex items-center gap-2 ml-auto">
            {/* Balance indicator */}
            {user && totalUsd > 0 && (
              <Link to="/wallet" className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-secondary/80 text-[11px] font-mono font-semibold text-foreground hover:bg-secondary transition-colors">
