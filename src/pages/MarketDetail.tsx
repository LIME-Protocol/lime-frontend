      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="surface-card p-5 animate-reveal-up stagger-3 glow-accent">
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="text-center min-w-[60px]">
                ...
                <p className="text-lg font-bold font-mono tabular-nums text-negative">{fmtVal(market.lowerBound)}</p>
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between mt-1.5">
                  ...
                  <span className="text-[10px] font-mono text-muted-foreground">Implied: <span className="text-warning font-semibold">{fmtVal(implied)}</span></span>
                  <span className="text-[10px] font-mono text-muted-foreground/60">100¢</span>
                </div>
              </div>
              <div className="text-center min-w-[60px]">
                <p className="data-label mb-1">Cap</p>
                <p className="text-lg font-bold font-mono tabular-nums text-positive">{fmtVal(market.upperBound)}</p>
                <p className="text-[10px] text-muted-foreground">{market.unit}</p>
              </div>
            </div>
          </div>
          ...
          <div className="surface-card p-5 animate-reveal-up stagger-4">
            ...
            <PayoffChart lower={market.lowerBound} upper={market.upperBound} currentPrice={market.currentPrice} unit={market.unit} resolvedValue={market.resolvedValue} referenceValue={market.referenceValue} height={280} curve={market.payoffCurve} />
          </div>
          ...
          <div className="surface-card p-5 animate-reveal-up stagger-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-4 text-sm">
              ...
              <DetailItem label="Resolution Date" value={new Date(market.resolutionDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })} icon={<Calendar className="h-3 w-3" />} />
          ...
          <div className="surface-card p-5 glow-accent animate-reveal-up stagger-1">
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono font-semibold text-muted-foreground">{fmtVal(market.lowerBound)}</span>
